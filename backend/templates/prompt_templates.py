...
Generate a list of shots, where each shot has a duration, a short searchable phrase to find a good shot from pixaby (1 - 2 words), and a suggestion for the background music genre.
"""
