...
//      if (snap.isBold) setIsbold(snap.isBold);
//      if (snap.isItalic) setIsItalic(snap.isItalic);
...
//       if (
//         parsed.defaultHashtags &&
//         parsed.defaultHashtags.length > 0 &&
//         hashtags.length === 0
//       ) {
...
//               </CardHeader>
//               <CardContent>
//                 <div className="origin-top mx-auto aspect-square bg-white rounded-lg overflow-hidden relative">
//                   <Image
//                     src={imageUrl}
